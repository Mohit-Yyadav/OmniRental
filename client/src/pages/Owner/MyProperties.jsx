                  ...
                  <h3 className="owner-properties__stat-value">
                    ...
                    {properties
                      .reduce(
                        (sum, p) =>
                          sum +
                          (p.status === "Occupied" && typeof p.rent === "number"
                            ? p.rent
                            : 0),
                        0
                      )
            ...
            try {
              ...
              for (const key in values) {
                if (key === "amenities" && Array.isArray(values[key])) {
                  ...
                  formData.append(
                    "personRents",
                    JSON.stringify(values.personRents)
                  );
                } else if (key !== "images") {
                      ...
                      <Row gutter={16} key={key} style={{ marginBottom: 12 }}>
                        <Col span={12}>
                          <Form.Item
                            ...
                            rules={[
                              {
                                required: true,
                                message: "Enter number of persons",
                              },
                            ]}
                          >
                            <Input
                        ...
                        <Col span={10}>
                          <Form.Item
                            ...
                            name={[name, "rent"]}
                            rules={[
                              { required: true, message: "Enter rent amount" },
                            ]}
                          >
