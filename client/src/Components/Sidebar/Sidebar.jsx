  ...
  return (
    <>
      ...
      <div className={`sidebar d-flex flex-column ${isOpen ? "open" : ""}`}>
        ...
        <div className="sidebar-section">
          <div className="active section-title"><IoMdArrowDropright />Payment & Receipts</div>
          <div className='Menu-item'><RiSecurePaymentFill className="Menu-icon" /><a href="#">Rent Payments</a></div>
          <div className='Menu-item'><IoMdCall className="Menu-icon" /><a href="#">Payment Modes</a></div>
          <div className='Menu-item'><MdOutlineEditNote className="Menu-icon" /><a href="#">Payment Receipts</a></div>
          <div className='Menu-item'><IoGift className="Menu-icon" /><a href="#">Gateway Payments</a></div>
        </div>

        <div className="sidebar-section">
          <div className="active section-title"><IoMdArrowDropright />Apartment Management</div>
          <div className='Menu-item'><MdApartment className="Menu-icon" /><a href="#">Apartments</a></div>
          <div className='Menu-item'><FaLightbulb className="Menu-icon" /><a href="#">House Units</a></div>
          <div className='Menu-item'><IoLocationSharp className="Menu-icon" /><a href="#">Locations</a></div>
        </div>
      </div>
